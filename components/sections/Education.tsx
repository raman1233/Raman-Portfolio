    ...
    <section id="education" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
      <div className="max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-slate-800/80 to-slate-800/40 rounded-xl p-6 border border-slate-700 hover:border-cyan-500/50 transition-colors">
                <h4 className="text-lg font-bold text-white mb-1">Bachelor of Technology</h4>
                <p className="text-cyan-400 font-semibold mb-2">In Artificial Intelligence & Data Science</p>
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-full max-w-2xl bg-gradient-to-br from-slate-800/80 to-slate-800/40 rounded-xl p-6 border border-slate-700">
